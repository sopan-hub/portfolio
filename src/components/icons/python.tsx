...
export const Python = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <path d="M12 21.5a4.5 4.5 0 004.5-4.5h-9a4.5 4.5 0 004.5 4.5z" fill="currentColor" />
      <path d="M12 2.5a4.5 4.5 0 00-4.5 4.5h9a4.5 4.5 0 00-4.5-4.5z" fill="currentColor" />
      <g fill="currentColor">
