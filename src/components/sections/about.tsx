  ...
  return (
    <section id="about" className="relative py-20">
      <div className="container relative z-10">
        ...
        >
          <div className="mx-auto max-w-3xl aspect-square">
            <UiverseCard>
                <div className="flex flex-col justify-center h-full p-8">
                  <h2 className="uiverse-title text-4xl md:text-5xl">About Me</h2>
                  ...
                  <p className="uiverse-text mt-4 text-lg md:text-xl">
