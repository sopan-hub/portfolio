      ...
      <div className="container">
        ...
        >
          <div className="title-section">
            <h2 className="section-title mb-12 text-center text-3xl font-bold">My Skills</h2>
          </div>
          <div className={'product-grid'}>
            {Object.entries(skills).map(([category, skillList], index) => (
              ...
              >
                ...
                <div className="product-image-wrapper !h-auto !py-6">
                  ...
                  <ul className="uiverse-text mt-4 space-y-3 text-center">
                    {skillList.map((skill) => (
