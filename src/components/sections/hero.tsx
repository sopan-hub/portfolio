        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="max-w-md text-white/90 text-xs md:text-sm font-medium leading-relaxed">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex items-center justify-center w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/10 hover:bg-white/20 text-white/70 hover:text-white transition-all border border-white/10 backdrop-blur-md"
            ...
            <Button asChild size="lg" className="rounded-full px-8 md:px-10 h-12 md:h-14 bg-white text-black font-bold hover:scale-105 transition-transform group text-[10px] md:text-xs tracking-widest uppercase">
          ...
          <div className="lg:col-span-5 flex justify-end">
            <GlassSurface
              borderRadius={32}
              className="p-6 md:p-10 shadow-2xl max-w-sm md:max-w-md bg-white/[0.05] border-white/5"
            >
              <h3 className="text-[8px] md:text-[9px] font-bold tracking-[0.4em] text-white/30 mb-4 md:mb-6 uppercase">
                MISSION BRIEF
              </h3>
