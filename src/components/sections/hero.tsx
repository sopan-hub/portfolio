...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-[calc(100vh-5rem)] items-center justify-center overflow-hidden bg-background p-4"
    >
      <div className="relative w-full h-[calc(100vh-8rem)] rounded-3xl overflow-hidden shadow-2xl">
        <video
          autoPlay
          loop
          muted
