...
const getGradientDirection = (position: string | number) =>
  ({
    top: 'to top',
    bottom: 'to bottom',
    left: 'to left',
...
const debounce = (fn: { (...a: any[]): void; }, wait: number | undefined) => {
...
const useResponsiveDimension = (responsive: any, config: { [x: string]: any; }, key: string) => {
...
const useIntersectionObserver = (ref: React.MutableRefObject<null>, shouldObserve = false) => {
...
function GradualBlur(props: { preset?: string | number; }) {
